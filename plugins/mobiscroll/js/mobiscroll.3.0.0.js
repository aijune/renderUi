(function (root, factory) {
    ...
    (function (j, d, m) {
        ...
        b.classes.Frame = function (aa, _, ac) {
            var S, x, a0, M, r, L, $, F, w, a3, C, z, t, v, y, s, W, P, D, E, A, H, G, Y, B, K, T, p, N, O, X, Q, R,
                i = this,
                u = a(aa),
                U = [],
                V = {};
    ...
    (function (h) {
        ...
        g.ScrollView = function (I, a1, aa) {
            var y, a0, N, P, M, t, $, L, W, Z, a9, r, K, ab, A, E, D, O, F, J, T, G, H, a4, Q, u, v, x, a3, X, a2, _, B,
                Y, w, e, p = this,
                s, z = 0,
                R = 1,
                a = a1,
    ...
    (function (e) {
        ...
        b.classes.Slider = function (K, a5, a6) {
            var j, M, T, s, R, n, y, U, q, w, I, Y, a2, J, z, V, r, A, B, Q, u, a3, p, k, x, t, l, m, H, G, X, P, C, L,
                i, h = this,
                O = new Date();
    ...
    (function (i, e, b) {
        ...
        f.calbase = function (g) {
            ...
            var V, B, Z, la, ea, O, da, pa, qa, Y, S, I, ia, R, xa, Ia, P, fa, K, ka,
                W, na, F, ma, Qa, ha, Va, Aa, Ra, Sa, wa, ib, ob, jb, oa, ra, Ab, mb, Mb, La, Wa, Ca, Pa, kb, Ob, $a,
                Eb, Ya, ja, Na, nb, sa, tb, xb, bb, hb, Ua, Pb = this,
                zb = [],
                va = [],
                sb = [],
                Da = {},
    ...
    (function (n, h, f) {
        ...
        k.ListView = function (bB, bH) {
            var R, ak, ac, E, aM, bx, bw, x, M, K, aJ, at, bA, I, a3, bD, aq, bs, J, a2, P, T, a6, bq, b8, bj, bh, A,
                as, aw, U, bp, aR, W, bt, bm, $, aY, aG, bk, bI, aV, b9, al, N, z, ae, u, D, w, b6, bQ, aA, az, aP, L,
                Y, a0, b0, b1, aL, aH, bC, ba, Q, H, Z, a1, aD, bg, aB, v, ab, a7, b3, b5, ar, bJ, bM, ax, au, S, V, aS,
                bu, aT, aF, av, y, af, ay, aQ, B, aa, ai, b7, g = this,
                G = bB,
                C = a(G),
                X = 0,
                a4 = 0,
